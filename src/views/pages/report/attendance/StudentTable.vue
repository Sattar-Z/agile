...
const fetchData = async () => {
  ...
  try {
    const response = await callApi({
      url: `school/students/${props.school}?term_id=${props.termId}&session=${props.session}&cohurt=${props.cohurt}`,
      method: 'GET',
      authorized: true,
      showAlert: false,
    })
...
watch(
  () => [props.termId, props.session, props.cohurt, props.school],
  () => {
    fetchData()
  },
  { immediate: true },
    ...
    >
      <VCard>
        ...
        >
          ...
          >
            <VCardText>
              <VCardTitle>{{ props.schoolName }} Students</VCardTitle>
            </VCardText>
          </VCol>
        </VRow>
        <VRow
